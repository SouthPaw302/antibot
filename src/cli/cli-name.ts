...
export const DEFAULT_CLI_NAME = "antibot";

const KNOWN_CLI_NAMES = new Set([DEFAULT_CLI_NAME, "antibot.mjs", "openclaw", "openclaw.mjs"]);
const CLI_PREFIX_RE = /^(?:((?:pnpm|npm|bunx|npx)\s+))?(antibot|openclaw)\b/;
